/*
  ...
  Simplified Board Bring Up and Test the BME280 and SFH2440 Light Sensor.  Matrix Test. Battery Voltage Test.  No Deep-Sleep Enabled.
  ...
  Pressure (hPa): 1013
  Light: 257
  ADC Value 	894	ADC Voltage 3.32 V Battery 178 % 	 (Probably DC Powered)   
*/
...
void loop() {
  ...
  Serial.print("Light: ");
  Serial.print(LightMeter);  // Value from the PhotoDiode (0-1024)
  Serial.println("");

/*
  ...
  PCA 2212-202 - Compact Weather Station - Basic Bring Up Test Code (BMP280)

  Simplified Board Bring Up and Test the BMP280 and SFH2440 Light Sensor.  Matrix Test. Battery Voltage Test.  No Deep-Sleep Enabled. Send to Domoticz
...
// ######### OBJECTS #########
Adafruit_BMP280 bmp;  //BMP280 connect to ESP8266 I2C (GPIO 4 = SDA, GPIO 5 = SCL)  // BME280 0x76 | BMP280 0x76 |  BMP180 0x77

// ######### VARIABLES / DEFINES / STATIC #########

// App
String AppVersion = "v2.221226";
String AppBuild = "DitroniX CWX-2-BMP280 12S SDK PCA";
